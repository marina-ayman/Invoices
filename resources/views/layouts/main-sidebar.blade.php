...
<link href="{{ URL::asset('assets/css/style-dark.css') }}" rel="stylesheet">
   ...
   @endsection
		...
		<aside class="app-sidebar sidebar-scroll p-0 m-0" style="background-color: #030d27ed; color:aliceblue">
		
			<div class="main-sidebar-header active" style="background-color: #040f2daf;">
...
<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'home')) }}"><img
	src="{{URL::asset('assets/img/brand/favicon.png')}}"  class="logo-icon"  alt="logo"></a>
				...
				<a class="desktop-logo logo-light active " href="{{ url('/' . $page='home') }}">
					<img  class="main-logo" src="{{ URL::asset('assets/img/1598265530_fgli2P_Benefits_of_e_Invoicing_for_Your_Business.jpg') }}"alt="logo" style="width: 15rem;height: 2.5rem;"></a>
			</div>
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/invoices-isolated-on-3d-black-round-button-abstract-illustration-TAEJEK.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0" style="color:aliceblue">{{ Auth::user()->name }}</h4>
							<span class="mb-0 " style="color:rgb(198, 198, 198)">{{ Auth::user()->email }}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					<li class="side-item side-item-category">برنامج فاتوره</li>
					...
					@can('الفواتير')			
					<li class="side-item side-item-category" style="color:aliceblue">فواتير</li>

					<li class="slide" style="color:aliceblue" >
						...
						<li><a class="slide-item" href="{{ url('/' . $page='invoice_partial') }}">الفواتير المدفوعه جزئيا</a></li>
						@endcan
						@can( 'ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='Arctive_Invoices') }}">الفواتير المؤرشفه</a></li>
							@endcan
					...
					<li class="side-item side-item-category" style="color:aliceblue">التقارير</li>
					<li class="slide" style="color:aliceblue">
						...
						<ul class="slide-menu">
							...
							@endcan
							@can( 'تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='customers_report') }}">تقارير العملا</a></li>
							@endcan
							</ul>
					</li>
					@endcan
					...
					<li class="slide">
						...
						@can('الاقسام')
							...
							@endcan
							@can( 'المنتجات')	
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">منتجات</a></li>
                           @endcan
								</ul>
					</li>
					@endcan
