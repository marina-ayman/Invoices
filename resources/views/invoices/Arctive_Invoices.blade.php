													...
													<td>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu tx-13">
																<h6 class="dropdown-header tx-uppercase tx-11 tx-bold tx-inverse tx-spacing-1">عمليات علي الفاتوره </h6>
															
                                                                <a class="dropdown-item" href="#" data-id="{{ $invoice->id }}" data-invoice_number="{{ $invoice->invoice_number }}" 
                                                                    data-toggle="modal" data-target="#unArchive_invoice"><i
                                                                        class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;الغاء ارشفة االفاتوره
                                                                    </a>
	
															<div class="dropdown-divider"></div>
																
																   <a class="dropdown-item" href="#delete_invoice" data-id="{{ $invoice->id }}"
			...
			<div class="modal" id="delete_invoice">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						...
						<form action="Arctive_Invoices/destroy" method="post">
							{{ method_field('delete') }}
							{{ csrf_field() }}
...
<script>
    $('#unArchive_invoice').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var invoice_number = button.data('invoice_number')
        var modal = $(this)
